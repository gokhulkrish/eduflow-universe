import {
  GraduationCap, ClipboardCheck, FileBarChart, Calendar, CreditCard,
...
export const moduleConfigs: Record<string, Cfg> = {
  admissions: {
    title: "Admissions & Enrollment", subtitle: "Application intake · verification · onboarding",
  ...
  attendance: {
    ...
    features: ["Cohort-wise Roll Call", "Biometric Sync", "Auto Alerts to Guardians", "Leave Approvals", "Trend Analytics", "Discrepancy Audit"],
  },
  exams: {
  ...
  parents: {
    title: "Student & Guardian Portal", subtitle: "Single pane for every family member",
  ...
  live: {
    title: "Live Sessions", subtitle: "Integrated video conferencing UI",
