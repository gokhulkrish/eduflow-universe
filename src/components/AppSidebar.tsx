...
import {
  ...
  GitCompare, AlertTriangle, FileText, Send, Radio,
} from "lucide-react";
import {
...
const campus: SidebarItem[] = [
  ...
  { title: "Duplicates", url: "/students/duplicates", icon: GitCompare },
  { title: "Missing Fields", url: "/students/missing-fields", icon: AlertTriangle },
...
const community: SidebarItem[] = [
  ...
  { title: "Comms Templates", url: "/comms/templates", icon: FileText },
  { title: "Comms Campaigns", url: "/comms/campaigns", icon: Send },
  { title: "Bulk Composer", url: "/comms/bulk", icon: MessageSquare },
  { title: "Message Logs", url: "/comms/logs", icon: ClipboardList },
  { title: "Notice Composition", url: "/comms/notices", icon: ClipboardList },
  { title: "Emergency Broadcast", url: "/comms/emergency", icon: Radio },
  { title: "Feedback Forms", url: "/comms/feedback", icon: ClipboardCheck },
  { title: "Class Wall", url: "/comms/class-wall", icon: LayoutPanelTop },
  { title: "Automation Rules", url: "/comms/automation", icon: Workflow },
