...
>(({ className, children, accessibleTitle, ...props }, ref) => {
  const content = ensureHiddenTitle(children, [DialogTitle, DialogPrimitive.Title], accessibleTitle ?? "Dialog");
  const describedBy = props["aria-describedby"];
  const contentProps = hasNestedDescription(children, [DialogDescription, DialogPrimitive.Description]) || describedBy !== undefined
    ? props
