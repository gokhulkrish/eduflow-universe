-- Split shared access aliases into unique permission keys so the registry
-- and Permission Matrix become 1:1 at the app-rule level.
...
declare
  hod_manage_modules text[] := array[
    'students', 'studentImport', 'studentInformation', 'studentSearch', 'academics',
    'admissions', 'attendance', 'exams', 'timetable', 'assignments', 'homework',
    'quiz', 'courseInfo', 'collegeInfo', 'communication', 'chat', 'events',
    'notifications', 'media', 'placement', 'alumni', 'reports', 'reportsAnalytics',
    'documents', 'observation', 'health', 'grievances', 'videoRooms',
    'videoRoomsSystem'
  ];
  ...
  staff_manage_modules text[] := array[
    'administration', 'administrationSystem', 'people', 'reception', 'tasks',
    'inventory', 'communication', 'chat', 'events', 'notifications', 'media',
    'documents', 'observation', 'health', 'grievances'
  ];
  ...
  student_view_modules text[] := array[
    ...
    'videoRooms', 'videoRoomsSystem', 'parents'
  ];
begin
...
insert into public.permissions (module_key, action, label) values
  ('administrationSystem', 'view', 'View Administration'),
  ('settingsHeaders', 'view', 'View Headers & Fields'),
  ('studentImport', 'view', 'View Import'),
  ('studentInformation', 'view', 'View Student Information'),
  ('studentSearch', 'view', 'View Student Search'),
  ('videoRoomsSystem', 'view', 'View Video Rooms')
